...
public class DialogueWindow : Selectable {

    public static List<DialogueWindow> m_openedWindows = new List<DialogueWindow>();
    ...
    private void Init() {
        ...
        m_choiceTemplate = transform.Find("Dialogue Choice").gameObject;
    ...
    public void Setup(DialogueController p_controller, string p_title) {
        Init();
